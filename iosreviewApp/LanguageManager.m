...
#import "Defines.h"
static NSString * const LanguageCodes[] = { @"en", @"ta-SG", @"ms", @"zh-Hans" };
static NSString * const LanguageStrings[] = { @"English", @"Singapore", @"Malay", @"Chinese" };
...
+ (void)setupCurrentLanguage
{
    ...
    [[NSUserDefaults standardUserDefaults] synchronize];
#else
    [NSBundle setLanguages:currentLanguage];
#endif
}
