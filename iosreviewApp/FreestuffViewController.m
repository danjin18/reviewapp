...
#import "FreestuffViewController.h"
...
@interface FreestuffViewController ()
{
    Preference *pref;
    int selected_row;
}
...
@implementation FreestuffViewController
...
-(void)getFreeStuff
{
    ...
    NSURL *URL = [NSURL URLWithString:API_POST_GET_FREESTUFF];
    ...
    [manager POST:URL.absoluteString parameters:parameters progress:nil success:^(NSURLSessionDataTask * task, id  responseObject) {
        ...
        if (responseObject == nil) {
            ...
            @try {
               _arrPromotion = [[promotionModel alloc] initFreeStuff:[json objectForKey:@"Data"]];
                [_myTable reloadData];
            }
            @catch (NSException *e) {
