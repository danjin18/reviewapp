//
//  RecentFeaturedViewController.m
//  iosreviewApp
//
...
#import "RecentFeaturedViewController.h"
...
#import "Preference.h"
#import "Constants.h"
@interface RecentFeaturedViewController ()
{
    int selected_row;
    NSString *selPhoto;
    Preference *pref;
...
@implementation RecentFeaturedViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [_myTable registerNib:[UINib nibWithNibName:@"RecentProductTableViewCell" bundle:nil] forCellReuseIdentifier:@"RecentProductTableViewCell"];
